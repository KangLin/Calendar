...
export EXTRA_QT_MODULES="svg;sql;statemachine"
...
cp Calendar-`uname -m`.AppImage $REPO_ROOT/Calendar_`uname -m`.AppImage
echo_status "Generated AppImage: $REPO_ROOT/Calendar_`uname -m`.AppImage"
