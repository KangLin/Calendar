...
function(GENERATED_DEPLOYMENT_SETTINGS)
    ...
    if(Qt5_VERSION VERSION_GREATER_EQUAL "5.14.0")
        FILE(APPEND ${_file_name} "\"architectures:\":{\n")
        if(ANDROID_BUILD_ABI_armeabi-v7a)
            FILE(APPEND ${_file_name} "\"armeabi-v7a:\":\"arm-linux-androideabi\",\n")
        endif()
        if(ANDROID_BUILD_ABI_arm64-v8a)
            FILE(APPEND ${_file_name} "\"arm64-v8a:\":\"aarch64-linux-android\",\n")
        endif()
        if(ANDROID_BUILD_ABI_x86)
            FILE(APPEND ${_file_name} "\"x86:\":\"i686-linux-android\",\n")
        endif()
        if(ANDROID_BUILD_ABI_x86_64)
            FILE(APPEND ${_file_name} "\"x86_64:\":\"x86_64-linux-android\",\n")
        endif()
