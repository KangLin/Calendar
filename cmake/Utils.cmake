...
MACRO(GENERATED_DEPLOYMENT_SETTINGS)
    SET(_file_name "${PROJECT_BINARY_DIR}/android-App.so-deployment-settings.json")
    ...
    FILE(APPEND ${_file_name} "\"sdk\":\"$ENV{ANDROID_SDK_ROOT}\",\n")
    FILE(APPEND ${_file_name} "\"ndk\":\"$ENV{ANDROID_NDK_ROOT}\",\n")
