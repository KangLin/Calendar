...
- windows:  
  ...
  + [从 sourceforge 下载 Calendar_Setup_v1.0.6.exe ](https://sourceforge.net/projects/rabbitcalendar/files/v1.0.6/Calendar_Setup_v1.0.6.exe/download)
  + [从 Github 下载 Calendar_Setup_v1.0.6.exe](https://github.com/KangLin/Calendar/releases/download/v1.0.6/Calendar_Setup_v1.0.6.exe)  
- android:
  + [从 github 下载 Calendar_armeabi-v7a_v1.0.6.apk](https://github.com/KangLin/Calendar/releases/download/v1.0.6/Calendar_v1.0.6.apk)
...
- Ubuntu:
  + Ubuntu 20.04: calendar_1.0.6_amd64_Ubuntu-20.04.deb
    ...
    - [从 github 下载](https://github.com/KangLin/calendar/releases/download/v1.0.6/calendar_1.0.6_amd64_Ubuntu-20.04.deb)
    - [从 sourceforge 下载](https://sourceforge.net/projects/calendar/files/v1.0.6/calendar_1.0.6_amd64_Ubuntu-20.04.deb/download)
  + md5 校验文件: calendar_1.0.6_amd64_Ubuntu-20.04.deb.md5sum
    - [从 github 下载](https://github.com/KangLin/calendar/releases/download/v1.0.6/calendar_1.0.6_amd64_Ubuntu-20.04.deb.md5sum)
    - [从 sourceforge 下载](https://sourceforge.net/projects/calendar/files/v1.0.6/calendar_1.0.6_amd64_Ubuntu-20.04.deb.md5sum/download)
  + Ubuntu 18.04: calendar_1.0.6_amd64_Ubuntu-18.04.deb
    ...
    - [从 github 下载](https://github.com/KangLin/calendar/releases/download/v1.0.6/calendar_1.0.6_amd64_Ubuntu-18.04.deb)
    - [从 sourceforge 下载](https://sourceforge.net/projects/calendar/files/v1.0.6/calendar_1.0.6_amd64_Ubuntu-18.04.deb/download)
  + md5 校验文件: calendar_1.0.6_amd64_Ubuntu-18.04.deb.md5sum
    - [从 github 下载](https://github.com/KangLin/calendar/releases/download/v1.0.6/calendar_1.0.6_amd64_Ubuntu-18.04.deb.md5sum)
    - [从 sourceforge 下载](https://sourceforge.net/projects/calendar/files/v1.0.6/calendar_1.0.6_amd64_Ubuntu-18.04.deb.md5sum/download)
