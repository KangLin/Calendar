...
!define MUI_ICON "install\AppIcon.ico"
!define MUI_UNICON "install\AppIcon.ico"
...
LangString LANG_PRODUCT_NAME ${LANG_ENGLISH} "Tasks"
...
Function AutoBoot
    WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "Software\Microsoft\Windows\CurrentVersion\RunOnce" "${PRODUCT_NAME}" "$INSTDIR\bin\${PRODUCT_NAME}.exe"
FunctionEnd
